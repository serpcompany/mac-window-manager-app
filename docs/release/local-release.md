...
Release configurations use Apple Distribution automatic signing and sandboxed release entitlements. Local unsigned builds can verify compilation and identity, but they are not submission artifacts.
